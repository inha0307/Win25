...
int main() 
{
    ...
    RGB face = { 0.0f, 0.45f, 1.0f, 0.0f, 0.45f, 1.0f };
    ...
    while (!glfwWindowShouldClose(window)) 
    {
        ...
        drawEllipse(0.0f, 0.0f, 0.8f, 0.7f, 100, face);
        drawCircle(0.6f, 0.2f, 0.05f, 100, eyes);
        drawCircle(-0.6f, 0.2f, 0.05f, 100, eyes);
        drawEllipse(-0.15f, -0.25f, 0.17f, 0.14f, 100, nois_w);
        drawEllipse(0.15f, -0.25f, 0.17f, 0.14f, 100, nois_w);
        drawLine(-0.25f, -0.2f, -0.45f, -0.15f, 2.5f, line);
        drawLine(-0.25f, -0.25f, -0.45f, -0.25f, 2.5f, line);
        drawLine(-0.25f, -0.30f, -0.45f, -0.35f, 2.5f, line);
        drawLine(0.25f, -0.2f, 0.45f, -0.15f, 2.5f, line);
        drawLine(0.25f, -0.25f, 0.45f, -0.25f, 2.5f, line);
        drawLine(0.25f, -0.30f, 0.45f, -0.35f, 2.5f, line);
        drawEllipse(0.0f, -0.125f, 0.12f, 0.1f, 100, nois);
